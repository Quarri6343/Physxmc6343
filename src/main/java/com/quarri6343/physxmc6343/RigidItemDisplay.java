...
public class RigidItemDisplay {
    ...
    public void create(Player player){
        ...
        PhysxBox box = Physxmc6343.physx.addBox(new PxVec3((float) loc.x(), (float) loc.y(), (float) loc.z()), new PxQuat(playerQuat.x, playerQuat.y, playerQuat.z, playerQuat.w), boxGeometry);
    ...
    public void update(){
        ...
        Bukkit.getOnlinePlayers().forEach(player -> {
            ...
            if(playerCollisionList.get(player) == null){
                PhysxBox box = Physxmc6343.physx.addBox(new PxVec3((float) loc.x(), (float) loc.y() + 1, (float) loc.z()), new PxQuat(PxIDENTITYEnum.PxIdentity));
